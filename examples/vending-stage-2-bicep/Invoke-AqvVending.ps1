<#
    ...
    .EXAMPLE
    ./Invoke-AqvVending.ps1 -SubscriptionId $subId

    Evaluates the decision and writes aqv-apply.bicepparam. Nothing is deployed.

    .EXAMPLE
    ./Invoke-AqvVending.ps1 -SubscriptionId $subId -Deploy
...
# The handoff to Bicep. `writes_required` is already the shape aqv-apply.bicep
...
# modules/aqv-apply/README.md for the three refusal codes, none retryable.
...
New-AzSubscriptionDeployment `
    ...
    -Name ("aqv-quota-{0}" -f (Get-Date -Format 'yyyyMMddHHmmss'))
